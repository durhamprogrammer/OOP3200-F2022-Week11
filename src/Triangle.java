public class Triangle extends Shape
{
    ...
    public Triangle(Vector2[] vertices) throws Exception
    {
        ...
        {
            checkIfAnyVerticesAreEqual(vertices[0], vertices[1], vertices[2]);
    ...
    public void setVertices(Vector2 p1, Vector2 p2, Vector2 p3) throws Exception
    {
        ...
        checkIfAnyVerticesAreEqual(p1, p2, p3);
        super.setVertices(vertices);
    }

    // private methods

    private void checkIfAnyVerticesAreEqual(Vector2 p1, Vector2 p2, Vector2 p3) throws Exception
    {
        // check if any of the Vector2s are the same
